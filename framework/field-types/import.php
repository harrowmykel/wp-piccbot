...
$ajax_url = html_entity_decode(wp_nonce_url('admin-ajax.php?action=pcbtt_csp4_import_settings','pcbtt_csp4_import_settings'));
...
echo "<script>
      jQuery(document).ready(function($) {
        $('#import-settings-btn').click(function() {
            if(confirm(pcbtt_csp4_msgs.import_confirm)){
