...
class PICCBOTT_CSP4{
    ...
    function admin_bar_menu($str){
        global $pcbtt_csp4_settings,$wp_admin_bar;
        extract($pcbtt_csp4_settings);
        ...
        $wp_admin_bar->add_menu( array(
            'id'     => 'pbtt-csp4-notice',
            'href' => admin_url().'options-general.php?page=pcbtt_csp4',
    ...
    function get_default_template(){
        $file = file_get_contents(PICCBOTT_CSP4_PLUGIN_PATH.'/themes/default/index.php');
        return $file;
    }
    ...
    function add_scripts($hook) {
        wp_enqueue_style( 'pbtt-csp4-adminbar-notification', PICCBOTT_CSP4_PLUGIN_URL.'inc/adminbar-style.css', false, PICCBOTT_CSP4_VERSION, 'screen');
    }
    ...
    function render_comingsoon_page() {
        ...
        if(empty($html)){
            ...
            require_once( PICCBOTT_CSP4_PLUGIN_PATH.'/themes/default/functions.php' );
            $template_tags = array(
                '{Title}' => pcbtt_csp4_title(),
                '{MetaDescription}' => pcbtt_csp4_metadescription(),
                '{Privacy}' => pcbtt_csp4_privacy(),
                '{Favicon}' => pcbtt_csp4_favicon(),
                '{CustomCSS}' => pcbtt_csp4_customcss(),
                '{Head}' => pcbtt_csp4_head(),
                '{Footer}' => pcbtt_csp4_footer(),
                '{Logo}' => pcbtt_csp4_logo(),
                '{Headline}' => pcbtt_csp4_headline(),
                '{Description}' => pcbtt_csp4_description(),
                '{Credit}' => pcbtt_csp4_credit(),
                '{Append_HTML}' => pcbtt_csp4_append_html(),
                );
