...
<?php include PICCBOTT_CSP4_PLUGIN_PATH.'resources/views/quicklinks.php'; ?>
    ...
    <div id="pcbtt_csp4_body">
        ...
        <h1 style="line-height:1.2; text-align:center">Upgrade to the Pro Version and Get<br>Access to Over 500,000 Free Stock Images</h1>
                <!-- <div id="pbtt-bg-images-form"><input type="email" id="pbtt-bg-images-email"  value="<?php echo get_option('admin_email')  ?>" /><button id="pbtt-bg-images-btn" class="button-primary">Send Me FREE Background Images</button></div> -->
                <script>
                ...
                <div id="display-stock-images" class="pbtt-csp4-clear"></div>
        </div>
        ...
        <?php $stockimages_ajax_url = html_entity_decode(wp_nonce_url('admin-ajax.php?action=pcbtt_csp4_backgrounds','pcbtt_csp4_backgrounds')); ?>
