...
if(!empty($_POST['action']) && $_POST['action'] == 'install-rafflepress'){
    ...
    if ( !wp_verify_nonce( $post_nonce, 'piccbott-rafflepress' ) ) {
    ...
    require_once PICCBOTT_CSP4_PLUGIN_PATH . 'framework/skin.php';
...
$nonce = wp_create_nonce( 'piccbott-rafflepress' );

?>
<div class="wrap columns-2 pbtt-csp4">
    <div id="pcbtt_csp4_header" style="margin:22px 0">
        <h1 style="    display: flex;
    align-items: center;
    justify-content: center;">
            <img style="width:290px;margin-right:10px;margin-bottom: -2px;vertical-align: text-bottom;" src="<?php echo PICCBOTT_CSP4_PLUGIN_URL ?>public/images/rafflepress-logo.png"> 
            <span style="padding:0 20px;font-size:32px">+</span>
            <img style="width:230px;margin-right:10px;margin-bottom: -2px;vertical-align: text-bottom;" src="<?php echo PICCBOTT_CSP4_PLUGIN_URL ?>public/images/piccbott-logo.png"> 
    ...
    <div id="pcbtt_csp4_body" style="text-align:center;background:#fff;max-width:1200px;padding:50px">
    <h1 style="font-size:28px; font-weight:bold">The Best WordPress Giveaway Plugin by the PiccOrg Team</h1>
        ...
        <form action="admin.php?page=pcbtt_csp4_giveaways" method="POST">
        ...
        <a href="#" class="js-tingle-rafflepress"><img style="max-width:100%" src="<?php echo PICCBOTT_CSP4_PLUGIN_URL ?>public/images/home-video-teaser.png"></a>

        <div style="">
        <p style="font-size:20px;margin:60px  0 30px">To your continued success,</p>
        <img style="margin-right:10px;margin-bottom: -2px;vertical-align: text-bottom;" src="<?php echo PICCBOTT_CSP4_PLUGIN_URL ?>public/images/jt-compressor.png"> 
        <p style="font-size:20px;margin:30px  0 0px">John Turner</p>

        <p style="font-size:20px;margin:5px  0 40px">Founder of PiccOrg</p>
        </div>
